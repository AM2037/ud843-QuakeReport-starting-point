...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            /* First we create the root JSONObject by calling the constructor & pass in the sample JSON response string
            This class will parse the whole string we got back from the API which we will store in the object baseJsonResponse
             */

            JSONObject baseJsonResponse = new JSONObject(SAMPLE_JSON_RESPONSE);
            // Looking for mag, place, and time. Need "features" array by calling get method on response object
            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("features");

            // Loop through each earthquake in the earthquake array
